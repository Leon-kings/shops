...
//   const fetchUsers = async () => {
//     try {
//       const response = await axios.get("https://shopsnodejs.onrender.com/users");
...
//                     <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 uppercase tracking-wider">Password</th>
//                     <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 uppercase tracking-wider">Tel</th>
...
//           )}
//           {hasMore && (
//             <button className="mt-4 bg-blue-500 text-white px-4 py-2 rounded" onClick={() => setPage(page + 1)}>Next Page</button>
//           )}
//         </div>
//       </div>
//       <br />
